...
class Switch(ApexEntity, SwitchEntity):
    ...
    def __init__(self, coordinator, switch, options):
        ...
        self._state = None
        self._device_id = f"apex_{switch[DID]}"
        self._attr_has_entity_name = True
        self._attr_name = f"apex_{switch[DID]}-{switch[NAME]}"
    ...
    def is_on(self):
        ...
        # if it wasn't cached, find it (this should be the normal behavior, XXX why?)
